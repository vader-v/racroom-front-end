  ...
  return (
    <nav>
      ...
      <ul className={`nav-links ${isOpen ? "open" : ""}`}>
        <div
          onClick={closeMenu}
          className={`hamburger-icon ${isOpen ? "inside" : ""}`}
        >
          &#9776;
        </div>
        {user ? (
          <>
            ...
            <li>
              <NavLink to="/trivia" onClick={closeMenu}>
                Trivia
              </NavLink>
            </li>
            <li>
              <NavLink to="/trivia/new" onClick={closeMenu}>
                Create
              </NavLink>
            </li>
            <li>
              <NavLink to="/profileList" onClick={closeMenu}>
                Profiles
              </NavLink>
            </li>
            <li>
            ...
            <li>
              <NavLink to="/auth/change-password" onClick={closeMenu}>
                Change Password
              </NavLink>
            </li>
            <li>
